            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('services.store') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <!-- Website -->
                            <div class="col-md-6" id="website-field" style="display: none;">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ip" id="ip" 
                                           ...
                                           value="{{ old('ip') }}" placeholder="192.168.1.1">
                                    @error('ip')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category" id="category" 
                                           ...
                                           value="{{ old('category') }}" placeholder="Công nghệ, Du lịch, Y tế...">
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="keywords" id="keywords" 
                                              ...
                                              rows="2" placeholder="keyword1, keyword2, keyword3...">{{ old('keywords') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" 
                                              ...
                                              rows="4" placeholder="Mô tả chi tiết về dịch vụ...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
