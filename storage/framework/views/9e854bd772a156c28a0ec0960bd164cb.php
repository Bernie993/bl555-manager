<?php $__env->startSection('title', 'Quản lý Website'); ?>
...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="btn-group">
                <?php if(auth()->user()->hasPermission('websites.create')): ?>
                <a href="<?php echo e(route('websites.create')); ?>" class="btn btn-primary">
                    <i class="fas fa-plus me-2"></i>
                    Thêm Website
                </a>
                <?php endif; ?>
                
                <?php if(auth()->user()->role && in_array(auth()->user()->role->name, ['admin', 'it'])): ?>
                <a href="<?php echo e(route('websites.cloudflare-sync')); ?>" class="btn btn-info">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('websites.index')); ?>">
            <div class="row g-3">
                <div class="col-md-4">
                    <label for="search" class="form-label">Tìm kiếm</label>
                    <input type="text" class="form-control" id="search" name="search" 
                           value="<?php echo e(request('search')); ?>" placeholder="Tên website hoặc seoer...">
                </div>
                <div class="col-md-3">
                    <label for="status" class="form-label">Trạng thái</label>
                    <select class="form-select" id="status" name="status">
                        <option value="">Tất cả trạng thái</option>
                        <option value="301" <?php echo e(request('status') === '301' ? 'selected' : ''); ?>>301</option>
                        <option value="not_configured" <?php echo e(request('status') === 'not_configured' ? 'selected' : ''); ?>>Site chưa cấu hình</option>
                        <option value="new_build" <?php echo e(request('status') === 'new_build' ? 'selected' : ''); ?>>Site mới dựng</option>
                        <option value="stop_seo" <?php echo e(request('status') === 'stop_seo' ? 'selected' : ''); ?>>Dừng seo</option>
                        <option value="recovered" <?php echo e(request('status') === 'recovered' ? 'selected' : ''); ?>>Thu hồi</option>
                    </select>
                </div>
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="seoer" name="seoer">
                        ...
                        <?php $__currentLoopData = $seoers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seoerUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($seoerUser->id); ?>" <?php echo e(request('seoer') == $seoerUser->id ? 'selected' : ''); ?>>
                                <?php echo e($seoerUser->name); ?>
    ...
    <div class="card-body">
        <?php if($websites->count() > 0): ?>
                        ...
                        <tr>
                            <td>
                                ...
                                <?php if($website->notes): ?>
                                    <br><small class="text-muted"><?php echo e(Str::limit($website->notes, 50)); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($website->seoerUser): ?>
                                    <?php echo e($website->seoerUser->name); ?>

                                <?php else: ?>
                                    <?php echo e($website->seoer ?? 'Chưa phân công'); ?>
                            ...
                            <td>
                                <div class="redirect-status-<?php echo e($website->id); ?>">
                            ...
                            <td>
                                <?php echo e($website->delivery_date ? $website->delivery_date->format('d/m/Y') : '-'); ?>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="<?php echo e(route('websites.edit', $website)); ?>" class="btn btn-sm btn-outline-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <?php endif; ?>
                                    <?php if(auth()->user()->hasPermission('websites.delete')): ?>
                                    <form action="<?php echo e(route('websites.destroy', $website)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="d-flex justify-content-center mt-4">
                <?php echo e($websites->withQueryString()->links()); ?>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <p class="text-muted">
                    <?php if(request()->hasAny(['search', 'status', 'seoer'])): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php $__currentLoopData = $websites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $website): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    check301StatusForWebsite(<?php echo e($website->id); ?>);
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
});
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/bl555pm.com/resources/views/websites/index.blade.php ENDPATH**/ ?>