...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Hệ thống quản lý BL555'); ?></title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php if(auth()->user()->hasPermission('websites.read')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('websites.*') ? 'active' : ''); ?>" href="<?php echo e(route('websites.index')); ?>">
                    ...
                    <?php if(auth()->user()->hasPermission('budgets.read')): ?>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('service-proposals.*') ? 'active' : ''); ?>" href="<?php echo e(route('service-proposals.index')); ?>">
                            <i class="fas fa-clipboard-list me-1"></i>
                            Đề xuất Dịch vụ
                        </a>
                    </li>

                    <?php if(auth()->user()->hasPermission('withdrawals.read')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('withdrawals.*') ? 'active' : ''); ?>" href="<?php echo e(route('withdrawals.index')); ?>">
                    ...
                    <?php if(auth()->user()->hasPermission('services.read')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('services.*') ? 'active' : ''); ?>" href="<?php echo e(route('services.index')); ?>">
                    ...
                    <?php if(auth()->user()->hasPermission('audit_logs.read')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('audit-logs.*') ? 'active' : ''); ?>" href="<?php echo e(route('audit-logs.index')); ?>">
                    ...
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle user-info" href="#" id="userDropdown" role="button"
                           data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <span class="badge ms-2"><?php echo e(auth()->user()->role->display_name); ?></span>
                        </a>
    ...
    <script>
        ...
        function loadNotifications() {
            ...
            fetch('<?php echo e(route("notifications.data")); ?>?limit=10')
                .then(response => response.json())
                .then(data => {
...
<?php /**PATH /www/wwwroot/bl555pm.com/resources/views/layouts/app.blade.php ENDPATH**/ ?>