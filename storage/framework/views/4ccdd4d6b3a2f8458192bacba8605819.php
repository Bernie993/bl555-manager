            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">
                        ...
                        Chi tiết yêu cầu rút tiền #<?php echo e($withdrawal->id); ?>

                    </h4>
                    <span class="badge <?php echo e($withdrawal->getStatusBadgeClass()); ?> fs-6">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td><?php echo e($withdrawal->partner->name); ?></td>
                                </tr>
                                <tr>
                                    <td><strong>Số tiền:</strong></td>
                                    <td class="text-primary fs-5 fw-bold"><?php echo e($withdrawal->formatted_amount); ?></td>
                                </tr>
                                <tr>
                                    <td><strong>Ngày tạo:</strong></td>
                                    <td><?php echo e($withdrawal->created_at->format('d/m/Y H:i')); ?></td>
                                </tr>
                                <tr>
                                    <td><strong>Số đề xuất:</strong></td>
                                    <td><?php echo e($withdrawal->serviceProposals->count()); ?> đề xuất</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-4">
                        <h6 class="text-muted mb-3">
                            ...
                            Danh sách đề xuất (<?php echo e($withdrawal->serviceProposals->count()); ?>)
                        </h6>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $withdrawal->serviceProposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(route('service-proposals.show', $proposal)); ?>" class="text-decoration-none">
                                                    <strong><?php echo e($proposal->service_name); ?></strong>
                                                </a>
                                                <br><small class="text-muted">SL: <?php echo e($proposal->quantity); ?></small>
                                            </td>
                                            <td><?php echo e($proposal->supplier_name); ?></td>
                                            <td>
                                                <strong class="text-primary"><?php echo e($proposal->formatted_amount); ?></strong>
                                            </td>
                                            <td>
                                                <strong class="text-success"><?php echo e(number_format($proposal->pivot->amount, 0, ',', '.')); ?> VNĐ</strong>
                                            </td>
                                            <td>
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-success"><?php echo e($withdrawal->formatted_amount); ?></th>
                                        <th></th>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <?php if($withdrawal->status !== 'pending'): ?>
                        <div class="mb-4">
                            ...
                            <?php if($withdrawal->assistant_processed_at): ?>
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><strong>Trợ lý:</strong> <?php echo e($withdrawal->assistantProcessor->name); ?></p>
                                                <p><strong>Thời gian:</strong> <?php echo e($withdrawal->assistant_processed_at->format('d/m/Y H:i')); ?></p>
                                                <?php if($withdrawal->assistant_note): ?>
                                                    <p><strong>Ghi chú:</strong> <?php echo e($withdrawal->assistant_note); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="col-md-6">
                                                <?php if($withdrawal->payment_proof_image): ?>
                                                    <p><strong>Ảnh bill chuyển khoản:</strong></p>
                                                    <img src="<?php echo e(asset('storage/' . $withdrawal->payment_proof_image)); ?>" 
                                                         class="img-fluid rounded" 
                                                         style="max-height: 200px; cursor: pointer;"
                                                         onclick="showImageModal('<?php echo e(asset('storage/' . $withdrawal->payment_proof_image)); ?>')"
                            ...
                            <?php if($withdrawal->partner_confirmed_at): ?>
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <p><strong>Đối tác:</strong> <?php echo e($withdrawal->partnerConfirmer->name); ?></p>
                                        <p><strong>Thời gian:</strong> <?php echo e($withdrawal->partner_confirmed_at->format('d/m/Y H:i')); ?></p>
                                        <?php if($withdrawal->partner_confirmation_note): ?>
                                            <p><strong>Ghi chú:</strong> <?php echo e($withdrawal->partner_confirmation_note); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <?php $__currentLoopData = $withdrawal->getAvailableActionsFor(auth()->user()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($action['action'] === 'assistant_process'): ?>
                            <button type="button" class="btn <?php echo e($action['class']); ?> w-100 mb-2" 
                    ...
                    <a href="<?php echo e(route('withdrawals.index')); ?>" class="btn btn-outline-secondary w-100">
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item completed">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="mb-0 small">Bởi: <?php echo e($withdrawal->partner->name); ?></p>
                            </div>
                        </div>

                        <!-- Step 2: Assistant Process -->
                        <div class="timeline-item <?php echo e($withdrawal->assistant_processed_at ? 'completed' : ($withdrawal->status === 'pending' ? 'active' : '')); ?>">
                            <div class="timeline-marker <?php echo e($withdrawal->assistant_processed_at ? 'bg-info' : ($withdrawal->status === 'pending' ? 'bg-warning' : 'bg-light')); ?>"></div>
                            <div class="timeline-content">
                                <h6 class="mb-1">Trợ lý xử lý thanh toán</h6>
                                <?php if($withdrawal->assistant_processed_at): ?>
                                    <small class="text-muted"><?php echo e($withdrawal->assistant_processed_at->format('d/m/Y H:i')); ?></small>
                                    <p class="mb-0 small">Bởi: <?php echo e($withdrawal->assistantProcessor->name); ?></p>
                                <?php else: ?>
                        ...
                        <div class="timeline-item <?php echo e($withdrawal->partner_confirmed_at ? 'completed' : ($withdrawal->status === 'assistant_completed' ? 'active' : '')); ?>">
                            <div class="timeline-marker <?php echo e($withdrawal->partner_confirmed_at ? 'bg-success' : ($withdrawal->status === 'assistant_completed' ? 'bg-warning' : 'bg-light')); ?>"></div>
                            <div class="timeline-content">
                                <h6 class="mb-1">Đối tác xác nhận nhận tiền</h6>
                                <?php if($withdrawal->partner_confirmed_at): ?>
                                    <small class="text-muted"><?php echo e($withdrawal->partner_confirmed_at->format('d/m/Y H:i')); ?></small>
                                    <p class="mb-0 small">Bởi: <?php echo e($withdrawal->partnerConfirmer->name); ?></p>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/bl555pm.com/resources/views/withdrawals/show.blade.php ENDPATH**/ ?>